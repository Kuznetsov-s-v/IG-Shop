package com.eightyOne_ig.igshop.ui.utils
 ...
 */
/**
 * Изменяет элемент, добавляя границу с внешним видом, заданным параметрами [border] и [shape],
 * отступает содержимое на величину [BorderStroke.width] и обрезает его.
 * @param border Класс [BorderStroke], определяющий внешний вид границы, например, размер и цвет
 * @param shape Форма границы
 */
 ...
 */
/**
 * Возвращает [Modifier], который добавляет границу с внешним видом, заданным параметрами [width], [color] и [shape], отступает содержимое на величину [width] и обрезает его.
 * @param width Ширина границы. Используйте [Dp.Hairline] для тонкой линии.
 * @param color Цвет, которым будет нарисована граница.
 * @param shape Форма границы.
 * @param on Размер сплошной части штрихов.
 * @param off Размер пространства между штрихами.
 */
 ...
 */
/**
 * Возвращает [Modifier], который добавляет границу с внешним видом, заданным параметрами [width],
 * [brush] и [shape], отступает содержимое на величину [width] и обрезает его.
 * @param width Ширина границы. Используйте [Dp.Hairline] для тонкой линии.
 * @param brush Кисть, которой будет нарисована граница.
 * @param shape Форма границы.
 */
